...
public class SQLiteDbHelper extends SQLiteOpenHelper {
    ...
    private static final String WASHING_MACHINE_CREATE_TABLE_SQL = "create table " + TABLE_WASHING_MACHINE + "("
            ...
            + "cowboy_price_coin varchar(10) not null default '00.0',"
            + "cowboy_price_mobile varchar(10) not null default '00.0',"
            + "disinfection_before_price_coin varchar(10) not null default '00.0',"
            + "disinfection_before_price_mobile varchar(10) not null default '00.0',"
            + "disinfection_ing_price_coin varchar(10) not null default '00.0',"
            + "disinfection_ing_price_mobile varchar(10) not null default '00.0',"
            + "drying_price_coin varchar(10) not null default '00.0',"
            + "drying_price_mobile varchar(10) not null default '00.0',"
            + "rinse_price_coin varchar(10) not null default '00.0',"
            + "rinse_price_mobile varchar(10) not null default '00.0',"
            + "sheets_price_coin varchar(10) not null default '00.0',"
            + "sheets_price_mobile varchar(10) not null default '00.0',"
            + "softening_price_coin varchar(10) not null default '00.0',"
            + "softening_price_mobile varchar(10) not null default '00.0',"
            + "standard_price_coin varchar(10) not null default '00.0',"
            + "standard_price_mobile varchar(10) not null default '00.0',"
            + "washing_liquid_price_coin varchar(10) not null default '00.0',"
            + "washing_liquid_price_mobile varchar(10) not null default '00.0',"
            + "create_time timestamp default (datetime('now','localtime')),"
            + "update_time timestamp default (datetime('now','localtime'))"
            + ");";
    // 密码规则库默认规则333333
